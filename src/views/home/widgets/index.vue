		...
		<div class="widgets-content">
			<div class="widgets-top">
				...
				<div class="widgets-top-actions">
					...
					<el-button v-else type="primary" icon="el-icon-edit" round @click="custom">自定義</el-button>
				</div>
			</div>
			<div class="widgets" ref="widgets">
				<div class="widgets-wrapper">
					<div v-if="nowCompsList.length<=0" class="no-widgets">
						<el-empty image="img/no-widgets.svg" description="沒有部件啦" :image-size="280"></el-empty>
					</div>
					<el-row :gutter="15">
		...
		<div v-if="customizing" class="widgets-aside">
			<el-container>
				...
				<el-main class="nopadding">
					<div class="widgets-list">
						<div v-if="myCompsList.length<=0" class="widgets-list-nodata">
							<el-empty description="沒有部件啦" :image-size="60"></el-empty>
						</div>
				...
				<el-footer style="height:51px;">
					<el-button size="small" @click="backDefaul()">恢復默認</el-button>
				</el-footer>
			</el-container>
		</div>
	</div>
