<template>
	<el-main>
		<el-alert title="感謝codeMirror組件" type="success" style="margin-bottom:20px;"></el-alert>
		<el-row :gutter="15">
			<el-col :lg="24">
				<el-card shadow="never" header="JSON">
					<sc-code-editor ref="editor" v-model="json" mode="javascript" :height="200"></sc-code-editor>
					<div style="margin-top: 15px;">
						<el-button type="primary" @click="getCode">獲取v-model</el-button>
			...
			<el-col :lg="12">
				<el-card shadow="never" header="javascript Darcula主題">
