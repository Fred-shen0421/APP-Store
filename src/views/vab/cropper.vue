	...
	<el-main>
		<el-row :gutter="15">
			<el-col :lg="14">
				...
				<el-card shadow="never" header="參數和方法">
					<el-form label-width="100px">
						<el-form-item label="aspectRatio">
						    <el-select v-model="aspectRatio" placeholder="請選擇">
							...
							<div class="el-form-item-msg">固定選區或者不固定</div>
						</el-form-item>
						<el-form-item label="compress">
						    <el-select v-model="compress" placeholder="請選擇">
								<el-option label="0.1" :value="0.1"></el-option>
								<el-option label="0.5" :value="0.5"></el-option>
								<el-option label="1" :value="1"></el-option>
							</el-select>
							<div class="el-form-item-msg">圖像壓縮率，值為：0.1-1</div>
						</el-form-item>
					</el-form>
				...
				<el-card shadow="never" header="方法結果">
					<img :src="imgData" />
				</el-card>
			</el-col>
			<el-col :lg="10">
				<el-card shadow="never" header="已內置剪裁的上傳組件">
					<el-alert title="設置cropper就可以開啟上傳前剪裁, 並已封裝compress和aspectRatio, 打開F12查看網絡請求" type="success" style="margin-bottom:20px;"></el-alert>
					<sc-upload v-model="uploadImg" title="開啟剪裁" :cropper="true" :compress="1" :aspectRatio="1/1"></sc-upload>
				</el-card>
			</el-col>
		</el-row>
	</el-main>
...
<script>
	...
	export default {
		...
		data() {
			return {
				cropperImg: 'img/auth_banner.png',
				compress: 0.5,
				aspectRatio: 0,
				uploadImg: '',
				imgData: ''
