	...
	<el-container>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="list.apiObj" row-key="id" stripe>
				...
				<el-table-column label="性別" prop="sex" width="150" :filters="sexFilters" :filter-method="filterHandler">
				...
				<el-table-column label="評分" prop="num" width="150" sortable></el-table-column>
