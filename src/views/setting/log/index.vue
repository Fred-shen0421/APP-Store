<template>
	<el-container>
		<el-aside width="220px">
			<el-tree ref="category" class="menu" node-key="label" :data="category" :default-expanded-keys="['系統日誌']" current-node-key="系統日誌" :highlight-current="true" :expand-on-click-node="false">
			</el-tree>
		</el-aside>
		<el-container>
				...
				<el-container>
					...
					<el-main class="nopadding">
						<scTable ref="table" :apiObj="apiObj" stripe highlightCurrentRow @row-click="rowClick">
							<el-table-column label="級別" prop="level" width="60">
							...
							<el-table-column label="日誌名" prop="name" width="150"></el-table-column>
							<el-table-column label="請求接口" prop="url" width="150"></el-table-column>
							<el-table-column label="請求方法" prop="type" width="150"></el-table-column>
							<el-table-column label="用戶" prop="user" width="150"></el-table-column>
							<el-table-column label="客戶端IP" prop="cip" width="150"></el-table-column>
							<el-table-column label="日誌時間" prop="time" width="170"></el-table-column>
						</scTable>
					</el-main>
				</el-container>
			</el-main>
	...
	<el-drawer v-model="infoDrawer" title="日誌詳情" :size="600" destroy-on-close>
		<info ref="info"></info>
	</el-drawer>
</template>
