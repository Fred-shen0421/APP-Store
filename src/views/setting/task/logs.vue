...
<template>
	<el-container>
		<el-main  style="padding:0 20px;">
			<scTable ref="table" :data="data" stripe>
				<el-table-column label="執行時間" prop="time" width="200"></el-table-column>
				<el-table-column label="執行結果" prop="state" width="100">
				...
				<el-table-column label="執行日誌" prop="logs" width="100" fixed="right">
					<template #default="scope">
						<el-button size="small" @click="show(scope.row)" type="text">日誌</el-button>
					</template>
				</el-table-column>
			</scTable>
		</el-main>
	...
	<el-drawer title="日誌" v-model="logsVisible" :size="500" direction="rtl" destroy-on-close>
