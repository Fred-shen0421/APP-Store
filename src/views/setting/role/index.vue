	...
	<el-container>
		<el-header>
			<div class="left-panel">
				...
				<el-button type="primary" plain :disabled="selection.length!=1" @click="permission">權限設置</el-button>
			</div>
			<div class="right-panel">
				<div class="right-panel-search">
					<el-input v-model="search.keyword" placeholder="角色名稱" clearable></el-input>
		...
		<el-main class="nopadding">
			<scTable ref="table" :apiObj="apiObj" row-key="id" @selection-change="selectionChange" stripe>
				...
				<el-table-column label="角色名稱" prop="label" width="150"></el-table-column>
				<el-table-column label="別名" prop="alias" width="200"></el-table-column>
				...
				<el-table-column label="備註" prop="remark" min-width="150"></el-table-column>
