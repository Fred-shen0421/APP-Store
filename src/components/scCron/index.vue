...
<template>
	<el-input v-model="defaultValue" v-bind="$attrs">
		<template #append>
			<el-dropdown size="medium" @command="handleShortcuts">
				...
				<template #dropdown>
					<el-dropdown-menu>
						<el-dropdown-item command="0 * * * * ?">每分鐘</el-dropdown-item>
						<el-dropdown-item command="0 0 * * * ?">每小時</el-dropdown-item>
						<el-dropdown-item command="0 0 0 * * ?">每天零點</el-dropdown-item>
						<el-dropdown-item command="0 0 0 1 * ?">每月一號零點</el-dropdown-item>
						<el-dropdown-item command="0 0 0 L * ?">每月最後一天零點</el-dropdown-item>
						<el-dropdown-item command="0 0 0 ? * 1">每週星期日零點</el-dropdown-item>
						...
						<el-dropdown-item icon="el-icon-plus" divided command="custom">自定義</el-dropdown-item>
					</el-dropdown-menu>
				</template>
			</el-dropdown>
		</template>
	...
	<el-dialog title="cron規則生成器" v-model="dialogVisible" :width="580" destroy-on-close append-to-body>
		<div class="sc-cron">
			<el-tabs>
				<el-tab-pane>
					<template #label>
					...
					<el-form>
						<el-form-item label="類型">
							<el-radio-group v-model="value.second.type">
								...
								<el-radio-button label="1">範圍</el-radio-button>
								<el-radio-button label="2">間隔</el-radio-button>
								<el-radio-button label="3">指定</el-radio-button>
							</el-radio-group>
						</el-form-item>
						<el-form-item label="範圍" v-if="value.second.type==1">
						...
						<el-form-item label="間隔" v-if="value.second.type==2">
				...
				<el-tab-pane>
					...
					<el-form>
						...
						<el-form-item label="範圍" v-if="value.minute.type==1">
						...
						<el-form-item label="間隔" v-if="value.minute.type==2">
				...
				<el-tab-pane>
					...
					<el-form>
						...
						<el-form-item label="範圍" v-if="value.hour.type==1">
						...
						<el-form-item label="間隔" v-if="value.hour.type==2">
					...
					<el-form>
						<el-form-item label="類型">
							<el-radio-group v-model="value.day.type">
								...
								<el-radio-button label="2">間隔</el-radio-button>
								<el-radio-button label="3">指定</el-radio-button>
								<el-radio-button label="4">本月最後一天</el-radio-button>
								<el-radio-button label="5">不指定</el-radio-button>
							</el-radio-group>
						</el-form-item>
						<el-form-item label="範圍" v-if="value.day.type==1">
						...
						<el-form-item label="間隔" v-if="value.day.type==2">
				...
				<el-tab-pane>
					...
					<el-form>
						...
						<el-form-item label="範圍" v-if="value.month.type==1">
						...
						<el-form-item label="間隔" v-if="value.month.type==2">
						...
						<el-form>
							<el-form-item label="類型">
								<el-radio-group v-model="value.week.type">
									...
									<el-radio-button label="2">間隔</el-radio-button>
									<el-radio-button label="3">指定</el-radio-button>
									<el-radio-button label="4">本月最後一周</el-radio-button>
									<el-radio-button label="5">不指定</el-radio-button>
								</el-radio-group>
							</el-form-item>
							<el-form-item label="範圍" v-if="value.week.type==1">
							...
							<el-form-item label="間隔" v-if="value.week.type==2">
								第
							...
							<el-form-item label="最後一周" v-if="value.week.type==4">
				...
				<el-tab-pane>
					...
					<el-form>
						...
						<el-form-item label="範圍" v-if="value.year.type==1">
						...
						<el-form-item label="間隔" v-if="value.year.type==2">
	...
	export default {
		...
		methods: {
			...
			set(){
				...
				//簡單檢查
				if(arr.length < 6){
					this.$message.warning("cron表達式錯誤，已轉換為默認表達式")
					arr = "* * * * * ?".split(" ")
				}
