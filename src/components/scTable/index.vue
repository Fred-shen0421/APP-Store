	...
	<div class="scTable" :style="{'height':_height}" ref="scTableMain" v-loading="loading">
		...
		<div class="scTable-page" v-if="!hidePagination || !hideDo">
			...
			<div class="scTable-do" v-if="!hideDo">
				...
				<el-popover v-if="column" placement="top" title="列設置" :width="500" trigger="click" :hide-after="0" @show="customColumnShow=true" @after-leave="customColumnShow=false">
					<template #reference>
				...
				<el-popover v-if="!hideSetting" placement="top" title="表格設置" :width="400" trigger="click" :hide-after="0">
					<template #reference>
					...
					<el-form label-width="80px" label-position="left">
						...
						<el-form-item label="樣式">
							<el-checkbox v-model="config.border" label="縱向邊框"></el-checkbox>
							<el-checkbox v-model="config.stripe" label="斑馬紋"></el-checkbox>
						</el-form-item>
					</el-form>
				</el-popover>
			</div>
