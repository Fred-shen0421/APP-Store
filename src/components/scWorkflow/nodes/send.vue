	...
	<div class="node-wrap">
		<div class="node-wrap-box" @click="show">
			...
			<div class="content">
				...
				<span v-else class="placeholder">請選擇人員</span>
			</div>
		</div>
		<add-node v-model="nodeConfig.childNode"></add-node>
		<el-drawer title="抄送人設置" v-model="drawer" destroy-on-close append-to-body :size="500">
			<template #header>
			...
			<el-container>
				<el-main style="padding:0 20px 20px 20px">
					<el-form label-position="top">
						...
						<el-form-item label="">
							<el-checkbox v-model="form.userSelectFlag" label="允許發起人自選抄送人"></el-checkbox>
						</el-form-item>
					</el-form>
				</el-main>
				<el-footer>
