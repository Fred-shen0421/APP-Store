<template>
	<div class="node-wrap">
		...
		<el-drawer title="發起人" v-model="drawer" destroy-on-close append-to-body :size="500">
			<template #header>
			...
			<el-container>
				<el-main style="padding:0 20px 20px 20px">
					<el-form label-position="top">
						...
						<el-alert v-if="form.nodeRoleList.length==0" title="不指定則默認所有人都可發起此審批" type="info" :closable="false"/>
					</el-form>
				</el-main>
				<el-footer>
