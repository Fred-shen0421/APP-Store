	...
	<div class="branch-wrap">
		<div class="branch-box-wrap">
			<div class="branch-box">
				<el-button class="add-branch" type="success" plain round @click="addTerm">添加條件</el-button>
						...
						<div class="condition-node-box">
							<div class="auto-judge" @click="show(index)">
								...
								<div class="title">
									...
									<span class="priority-title">優先級{{item.priorityLevel}}</span>
								...
								<div class="content">
									...
									<span v-else class="placeholder">請設置條件</span>
								</div>
		...
		<el-drawer title="條件設置" v-model="drawer" destroy-on-close append-to-body :size="600">
			<template #header>
					...
					<el-form label-position="top">
						...
						<el-form-item>
							<el-table :data="form.conditionList">
								...
								<el-table-column prop="field" label="條件字段" width="130">
									<template #default="scope">
										<el-input v-model="scope.row.field" placeholder="條件字段"></el-input>
									</template>
								</el-table-column>
								<el-table-column prop="operator" label="運算符" width="130">
									<template #default="scope">
						...
						<p><el-button type="primary" icon="el-icon-plus" round @click="addConditionList">增加條件</el-button></p>
					</el-form>
				</el-main>
				<el-footer>
		...
		methods: {
			...
			toText(nodeConfig, index){
				...
				if (conditionList && conditionList.length == 1) {
					...
					return conditionList.length + "個條件，" + conditionModeText
				}else{
